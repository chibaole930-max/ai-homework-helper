            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-[11px] font-bold bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-300/80 px-2 py-0.5 rounded-full transition-colors"
